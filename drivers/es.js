...
function storeTypeMeta(opts, metadata, callback) {
  ...
  var createIndexReq = request.target.put(opts, '/' + opts.targetIndex, {
    "Content-Length": 0,
...
function storeAllMeta(opts, metadata, callback) {
  ...
  for (var index in metadata) {
    ...
    var createIndexReq = request.target.put(opts, '/' + index, {
      "Content-Length": buffer.length,
      "Content-Type": "application/json"
    }, done);
    createIndexReq.on('error', errorHandler);
...
exports.getData = function (opts, callback, retries) {
  ...
  if (exports.scrollId !== null) {
    ...
    var firstReq = request.source.post(opts, '/_search?search_type=query_then_fetch&scroll=60m', {
      "Content-Length": firstBuffer.length,
      "Content-Type": "application/json"
    }, handleResult);
...
exports.storeData = function (opts, data, callback, retries) {
  ...
  var putReq = request.target.post(opts, '/_bulk', {
    "Content-Length": buffer.length,
    "Content-Type": "application/json"
  }, function (res) {
